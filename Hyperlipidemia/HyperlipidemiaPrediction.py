...
def predictHyperlipidemiaClass(data):
    try:
        ...
        cols = [
            'AGE', 'SEX', 'L100700', 'S000300', 'L101700', 'L100800',
            'L101300', 'L190300', 'L190500', 'FIELD_33', 'FIELD_38', 'FIELD_40'
        ]
        ...
        data.columns = [
            'AGE', 'SEX', 'Uric Acid', 'BMI', 'r-GTP gamma', 'fasting glucose',
            'SGPT', 'RBC', 'HCT', '_4_1_Smoking', 'Drinking_5_1_days',
...
def predictHyperlipidemiaNextYearValue(data):
    try:
        ...
        cols = [
            'L190500', 'L190300', 'L101300', 'L100700', 'S000300', 'L101700',
            'L100800', 'L103300', 'L103100', 'FIELD_33', 'FIELD_38',
            'FIELD_40', 'SEX', 'AGE'
        ]
        ...
        cols_L103300 = [
            'L103300', 'L103100', 'L103000', 'L103200', 'S000300', 'L102900',
        ...
        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L100700_RF_regressor',
                'rb') as f:
            reg_L100700 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_S000300_regressor',
                'rb') as f:
            reg_S000300 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L101700_RF_regressor',
                'rb') as f:
            reg_L101700 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L100800_RF_regressor',
                'rb') as f:
            reg_L100800 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L103300_RF_regressor',
                'rb') as f:
            reg_L103300 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L103100_RF_regressor',
                'rb') as f:
            reg_L103100 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L101300_RF_regressor',
                'rb') as f:
            reg_L101300 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L190300_RF_regressor',
                'rb') as f:
            reg_L190300 = pickle.load(f)

        with open(
                'Hyperlipidemia/M_Ny/HM_nextyear_L190500_RF_regressor',
                'rb') as f:
            reg_L190500 = pickle.load(f)

        #    # predicte next year value
        predictedNextYearValues = pd.DataFrame()
        predictedNextYearValues['L100700'] = np.array(
            reg_L100700.predict(data[cols_L100700]))
        predictedNextYearValues['S000300'] = list(
            reg_S000300.predict(data[cols_S000300]))
        predictedNextYearValues['L101700'] = list(
            reg_L101700.predict(data[cols_L101700]))
        predictedNextYearValues['L100800'] = list(
            reg_L100800.predict(data[cols_L100800]))
        predictedNextYearValues['L103300'] = list(
            reg_L103300.predict(data[cols_L103300]))
        predictedNextYearValues['L103100'] = list(
            reg_L103100.predict(data[cols_L103100]))

        predictedNextYearValues['L101300'] = list(
            reg_L101300.predict(data[cols_L101300]))
        predictedNextYearValues['L190300'] = list(
            reg_L190300.predict(data[cols_L190300]))
        predictedNextYearValues['L190500'] = list(
            reg_L190500.predict(data[cols_L190500]))
        ...
        return ((str(e)) + ' Required Fields: ' + ', '.join(
            str(x)
            for x in np.unique(
                np.concatenate((cols_L100700, cols_S000300, cols_L101700,
                                cols_L100800, cols_L103300, cols_L103100,
                                cols_L101300, cols_L190300, cols_L190500)))))


def predictNextYearHyperlipidemiaClass(data):
    try:
        '''required columns to predict class status of the patient
        cols=['L100700','S000300','L101700','L100800','L103300',
        'L103100','FIELD_33','FIELD_38','FIELD_40','SEX','AGE']'''              
        cols = [
            'L190500', 'L190300', 'L101300', 'L100700', 'S000300', 'L101700',
            'L100800', 'L103300', 'L103100', 'FIELD_33', 'FIELD_38',
            'FIELD_40', 'SEX', 'AGE'
